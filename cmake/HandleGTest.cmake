...
# CQ GTest TARGET
add_library( CXXBLACS::gtest INTERFACE IMPORTED )
...
if( GTEST_FOUND )
  ...
  target_link_libraries( CXXBLACS::gtest INTERFACE GTest::GTest )
  ...
  target_link_libraries( CXXBLACS::gtest INTERFACE gtest )
